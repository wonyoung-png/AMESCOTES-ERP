...
export const TABLE_COLUMNS: Record<string, string[]> = {
  ...
  items: ['id', 'style_no', 'buyer_style_no', 'name', 'erp_category', 'sub_category', 'buyer_id', 'brand_code', 'season',
  ...
  boms: ['id', 'style_no', 'style_id', 'style_name', 'season', 'erp_category', 'designer', 'line_name',
         ...
         'pre_exchange_rate_cny', 'post_exchange_rate_cny', 'post_exchange_rate_usd', 'customs_rate', 'post_process_lines', 'post_delivery_price', 'post_subtotal_krw', 'post_total_cost_krw',
  ...
  production_orders: ['id', 'style_no', 'style_name', 'buyer_id', 'vendor_id', 'quantity', 'unit_price',
                      ...
                      'brand_batch_id', 'po_batch_no', 'ship_to', 'signatures', 'work_order_html', 'sent_at', 'confirmed_at', 'confirmed_date', 'confirm_note', 'shipped_qty', 'is_employee_purchase', 'milestones',
                      'created_at', 'updated_at'],
