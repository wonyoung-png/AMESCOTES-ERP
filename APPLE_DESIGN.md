...
- 큰 텍스트일수록 tracking을 **음수로** 좁힌다. 작은 텍스트는 양수로 넓힌다.
- 대문자 전체(ALL CAPS)는 섹션 아이브로우에만, letter-spacing +0.06em.
...
**규칙**
- 액센트 컬러는 **앱 전체에서 1개**. 브랜드 컬러가 있으면 Blue 자리를 대체한다.
- 컬러는 상태를 뜻할 때만 쓴다. 장식용 컬러 금지.
